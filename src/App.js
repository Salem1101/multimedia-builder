...
//      {file.isProtected && <LockIcon style={{width: 50, height: 50}} />}   
//      <p>{file.name}</p>    
//     </div>
//    );
//   }
   ...
   <div className="App">
    ...
    <div style={styles.container}>
     ...
     <div style={styles.controlTools}>
        ...
        <button style={styles.controlButton} onClick={handleProtectFile}>
  Protect
</button>



<button style={styles.controlButton} onClick={handleViewProtected}>
  View File
</button>
